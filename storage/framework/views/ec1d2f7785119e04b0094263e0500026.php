...
<head>
    ...
    <title><?php echo e(config('app.name', 'Sistema Integral de Gestion Automotriz')); ?></title>
    ...
    <script>
        ...
        window.SigaSessionUserId = <?php echo json_encode(auth()->id(), 15, 512) ?>;
        window.SigaSessionCheckUrl = <?php echo json_encode(route('session.user'), 15, 512) ?>;
    ...
    <link id="app-dark-css" rel="stylesheet" href="<?php echo e(asset('assets/compiled/css/app-dark.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/compiled/css/iconly.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/compiled/css/auth.css')); ?>">
...
<body class="<?php if(View::hasSection('auth')): ?> auth-theme <?php endif; ?>">
    <?php if (! (View::hasSection('auth'))): ?>
    <script src="<?php echo e(asset('assets/static/js/initTheme.js')); ?>"></script>
    <?php endif; ?>
    <div id="app">
        <?php if (! empty(trim($__env->yieldContent('auth')))): ?>
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('dashboard.ver')): ?>
                            <li class="sidebar-item <?php echo e(request()->routeIs('admin.index') || request()->routeIs('home') ? 'active' : ''); ?>">
                        ...
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('bi.ver')): ?>
                            <li class="sidebar-item <?php echo e(request()->routeIs('admin.bi.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.bi.index')); ?>" class='sidebar-link'>
                                    <i class="bi bi-bar-chart-line"></i>
                                    <span>BI</span>
                                </a>
                            </li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('notificaciones-operativas.ver')): ?>
                            <li class="sidebar-item <?php echo e(request()->routeIs('admin.notificaciones-operativas.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.notificaciones-operativas.index')); ?>" class='sidebar-link'>
                                    <i class="bi bi-bell-fill"></i>
                                    <span>Notificaciones</span>
                                </a>
                            </li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('auditoria-operativa.ver')): ?>
                            <li class="sidebar-item <?php echo e(request()->routeIs('admin.auditoria-operativa.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.auditoria-operativa.index')); ?>" class='sidebar-link'>
                                    <i class="bi bi-shield-check"></i>
                                    <span>Auditoria operativa</span>
                                </a>
                            </li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('chat.ver')): ?>
                            <li class="sidebar-item <?php echo e(request()->routeIs('admin.chat.*') ? 'active' : ''); ?>">
                        ...
                        <?php endif; ?>
                        <li class="sidebar-item <?php echo e(request()->routeIs('admin.manual-usuario.*') ? 'active' : ''); ?>">
                            <a href="<?php echo e(route('admin.manual-usuario.index')); ?>" class='sidebar-link'>
                                <i class="bi bi-journal-bookmark"></i>
                                <span>Manual de Usuario</span>
                            </a>
                        </li>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('bitacoras.ver')): ?>
                            <li class="sidebar-item <?php echo e(request()->routeIs('admin.bitacoras.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.bitacoras.index')); ?>" class='sidebar-link'>
                                    <i class="bi bi-journal-text"></i>
                                    <span>Bitacora</span>
                                </a>
                            </li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['ordenes-trabajo.ver', 'ordenes-trabajo.crear', 'ordenes-trabajo-articulos.agregar', 'ordenes-trabajo-motivos.ver', 'gestion-cubiertas.ver', 'movimiento-cubiertas.ver', 'movimiento-cubiertas.crear', 'controles-unidad.ver', 'controles-unidad.crear'])): ?>
                        <li class="sidebar-item has-sub <?php echo e(request()->routeIs('admin.ordenes-trabajo.*') || request()->routeIs('admin.ordenes-trabajo-motivos.*') || request()->routeIs('admin.gestion-cubiertas.*') || request()->routeIs('admin.movimiento-cubiertas.*') || request()->routeIs('admin.controles-unidad.*') ? 'active' : ''); ?>">
                            ...
                            <ul class="submenu submenu-closed" style="--submenu-height: 129px;">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('ordenes-trabajo.ver')): ?>
                                    <li class="submenu-item <?php echo e(request()->routeIs('admin.ordenes-trabajo.*') ? 'active' : ''); ?>">
                                        <a href="<?php echo e(route('admin.ordenes-trabajo.index')); ?>" class="submenu-link">Ordenes de Trabajo</a>
                                    </li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('ordenes-trabajo-motivos.ver')): ?>
                                    <li class="submenu-item <?php echo e(request()->routeIs('admin.ordenes-trabajo-motivos.*') ? 'active' : ''); ?>">
                                        <a href="<?php echo e(route('admin.ordenes-trabajo-motivos.index')); ?>" class="submenu-link">Motivos</a>
                                    </li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('gestion-cubiertas.ver')): ?>
                                    <li class="submenu-item <?php echo e(request()->routeIs('admin.gestion-cubiertas.*') || request()->routeIs('admin.movimiento-cubiertas.*') ? 'active' : ''); ?>">
                                        <a href="<?php echo e(route('admin.gestion-cubiertas.index')); ?>" class="submenu-link">Gestion cubiertas</a>
                                    </li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('controles-unidad.ver')): ?>
                                    <li class="submenu-item <?php echo e(request()->routeIs('admin.controles-unidad.*') ? 'active' : ''); ?>">
                                        <a href="<?php echo e(route('admin.controles-unidad.index')); ?>" class="submenu-link">Check List Vehicular</a>
                                    </li>
                                <?php elseif (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('controles-unidad.crear')): ?>
                                    <li class="submenu-item <?php echo e(request()->routeIs('admin.controles-unidad.*') ? 'active' : ''); ?>">
                                        <a href="<?php echo e(route('admin.controles-unidad.create')); ?>" class="submenu-link">Crear Check List</a>
                                    </li>
                                <?php endif; ?>
                            </ul>
                        </li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['flota.ver', 'servicios-kilometraje.ver', 'verificaciones-tecnicas.ver', 'historial-articulos-vehiculo.ver', 'configuracion-intervalos-servicio.ver', 'configuracion-vencimientos-verificacion.ver', 'titulares.ver', 'marca-vehiculo.ver', 'cia-seguro.ver', 'tipo-vehiculo.ver', 'marca-carroceria.ver', 'tipo-motor.ver', 'modelo-motor.ver', 'tipo-caja.ver', 'modelo-caja.ver'])): ?>
                        <li class="sidebar-item has-sub <?php echo e(request()->routeIs('admin.flota.*') || request()->routeIs('admin.servicios-kilometraje.*') || request()->routeIs('admin.verificaciones-tecnicas.*') || request()->routeIs('admin.configuracion-intervalos-servicio.*') || request()->routeIs('admin.configuracion-vencimientos-verificacion.*') || request()->routeIs('admin.historial-articulos-vehiculo.*') || request()->routeIs('admin.titulares.*') || request()->routeIs('admin.marca-vehiculo.*') || request()->routeIs('admin.cia-seguro.*') || request()->routeIs('admin.tipo-vehiculo.*') || request()->routeIs('admin.marca-carroceria.*') || request()->routeIs('admin.tipo-motor.*') || request()->routeIs('admin.modelo-motor.*') || request()->routeIs('admin.tipo-caja.*') || request()->routeIs('admin.modelo-caja.*') ? 'active' : ''); ?>">
                            <a href="#" class='sidebar-link'>
                            ...
                            <ul class="submenu submenu-closed" style="--submenu-height: 215px;">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('flota.ver')): ?><li class="submenu-item <?php echo e(request()->routeIs('admin.flota.*') ? 'active' : ''); ?>"><a href="<?php echo e(route('admin.flota.index')); ?>" class="submenu-link">Flota</a></li><?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('servicios-kilometraje.ver')): ?><li class="submenu-item <?php echo e(request()->routeIs('admin.servicios-kilometraje.*') ? 'active' : ''); ?>"><a href="<?php echo e(route('admin.servicios-kilometraje.index')); ?>" class="submenu-link">Servicios por km / hs</a></li><?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('verificaciones-tecnicas.ver')): ?><li class="submenu-item <?php echo e(request()->routeIs('admin.verificaciones-tecnicas.*') ? 'active' : ''); ?>"><a href="<?php echo e(route('admin.verificaciones-tecnicas.index')); ?>" class="submenu-link">Verificaciones tecnicas</a></li><?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('historial-articulos-vehiculo.ver')): ?><li class="submenu-item <?php echo e(request()->routeIs('admin.historial-articulos-vehiculo.*') ? 'active' : ''); ?>"><a href="<?php echo e(route('admin.historial-articulos-vehiculo.index')); ?>" class="submenu-link">Historial vehiculos</a></li><?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('historial-articulos-vehiculo.ver')): ?><li class="submenu-item <?php echo e(request()->routeIs('admin.costeo-vehiculos.*') ? 'active' : ''); ?>"><a href="<?php echo e(route('admin.costeo-vehiculos.index')); ?>" class="submenu-link">Costeo vehiculos</a></li><?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['configuracion-intervalos-servicio.ver', 'configuracion-vencimientos-verificacion.ver', 'titulares.ver', 'marca-vehiculo.ver', 'cia-seguro.ver', 'tipo-vehiculo.ver', 'marca-carroceria.ver', 'tipo-motor.ver', 'modelo-motor.ver', 'tipo-caja.ver', 'modelo-caja.ver'])): ?>
                                <li class="submenu-item has-sub <?php echo e(request()->routeIs('admin.configuracion-intervalos-servicio.*') || request()->routeIs('admin.configuracion-vencimientos-verificacion.*') || request()->routeIs('admin.titulares.*') || request()->routeIs('admin.marca-vehiculo.*') || request()->routeIs('admin.cia-seguro.*') || request()->routeIs('admin.tipo-vehiculo.*') || request()->routeIs('admin.marca-carroceria.*') || request()->routeIs('admin.tipo-motor.*') || request()->routeIs('admin.modelo-motor.*') || request()->routeIs('admin.tipo-caja.*') || request()->routeIs('admin.modelo-caja.*') ? 'active' : ''); ?>">
                                    <a href="#" class="submenu-link">Tablas auxiliares</a>
                                    <ul class="submenu submenu-level-2 ">
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('configuracion-intervalos-servicio.ver')): ?>
                                        <li class="submenu-item <?php echo e(request()->routeIs('admin.configuracion-intervalos-servicio.*') ? 'active' : ''); ?>">
                                            <a href="<?php echo e(route('admin.configuracion-intervalos-servicio.index')); ?>" class="submenu-link">Intervalos de servicios</a>
                                        </li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('configuracion-vencimientos-verificacion.ver')): ?>
                                        <li class="submenu-item <?php echo e(request()->routeIs('admin.configuracion-vencimientos-verificacion.*') ? 'active' : ''); ?>">
                                            <a href="<?php echo e(route('admin.configuracion-vencimientos-verificacion.index')); ?>" class="submenu-link">Tipos de verificaciones</a>
                                        </li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('titulares.ver')): ?>
                                        <li class="submenu-item <?php echo e(request()->routeIs('admin.titulares.*') ? 'active' : ''); ?>">
                                            <a href="<?php echo e(route('admin.titulares.index')); ?>" class="submenu-link">Titulares</a>
                                        </li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('marca-vehiculo.ver')): ?>
                                        <li class="submenu-item <?php echo e(request()->routeIs('admin.marca-vehiculo.*') ? 'active' : ''); ?>">
                                            <a href="<?php echo e(route('admin.marca-vehiculo.index')); ?>" class="submenu-link">Marca vehículo</a>
                                        </li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('cia-seguro.ver')): ?>
                                        <li class="submenu-item <?php echo e(request()->routeIs('admin.cia-seguro.*') ? 'active' : ''); ?>">
                                            <a href="<?php echo e(route('admin.cia-seguro.index')); ?>" class="submenu-link">Cía. seguro</a>
                                        </li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('tipo-vehiculo.ver')): ?>
                                        <li class="submenu-item <?php echo e(request()->routeIs('admin.tipo-vehiculo.*') ? 'active' : ''); ?>">
                                            <a href="<?php echo e(route('admin.tipo-vehiculo.index')); ?>" class="submenu-link">Tipo vehículo</a>
                                        </li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('marca-carroceria.ver')): ?>
                                        <li class="submenu-item <?php echo e(request()->routeIs('admin.marca-carroceria.*') ? 'active' : ''); ?>">
                                            <a href="<?php echo e(route('admin.marca-carroceria.index')); ?>" class="submenu-link">Marca carrocería</a>
                                        </li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('tipo-motor.ver')): ?>
                                        <li class="submenu-item <?php echo e(request()->routeIs('admin.tipo-motor.*') ? 'active' : ''); ?>">
                                            <a href="<?php echo e(route('admin.tipo-motor.index')); ?>" class="submenu-link">Tipo motor</a>
                                        </li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('modelo-motor.ver')): ?>
                                        <li class="submenu-item <?php echo e(request()->routeIs('admin.modelo-motor.*') ? 'active' : ''); ?>">
                                            <a href="<?php echo e(route('admin.modelo-motor.index')); ?>" class="submenu-link">Modelo motor</a>
                                        </li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('tipo-caja.ver')): ?>
                                        <li class="submenu-item <?php echo e(request()->routeIs('admin.tipo-caja.*') ? 'active' : ''); ?>">
                                            <a href="<?php echo e(route('admin.tipo-caja.index')); ?>" class="submenu-link">Tipo caja</a>
                                        </li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('modelo-caja.ver')): ?>
                                        <li class="submenu-item <?php echo e(request()->routeIs('admin.modelo-caja.*') ? 'active' : ''); ?>">
                                            <a href="<?php echo e(route('admin.modelo-caja.index')); ?>" class="submenu-link">Modelo caja</a>
                                        </li>
                                        <?php endif; ?>
                                    </ul>
                                </li>
                        ...
                        <li class="sidebar-item has-sub <?php echo e(request()->routeIs('admin.proveedores.*') ? 'active' : ''); ?>">
                            <a href="#" class='sidebar-link'>
                                <i class="bi bi-person"></i>
                                <span>Proveedores</span>
                            </a>
                            <ul class="submenu submenu-closed" style="--submenu-height: 86px;">
                                <li class="submenu-item <?php echo e(request()->routeIs('admin.proveedores.*') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('admin.proveedores.index')); ?>" class="submenu-link">Proveedores</a>
                                </li>
                            </ul>
                        </li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['pedidos-articulos.ver', 'pedidos-articulos.crear', 'solicitudes-repuestos.ver', 'solicitudes-repuestos.crear', 'ordenes-compra.ver', 'ordenes-compra.crear', 'compras.ver', 'entradas.ver', 'entradas.crear'])): ?>
                        <li class="sidebar-item has-sub <?php echo e(request()->routeIs('admin.compras.*') || request()->routeIs('admin.entradas.*') || request()->routeIs('admin.ordenes-compra.*') || request()->routeIs('admin.pedidos-articulos.*') || request()->routeIs('admin.solicitudes-repuestos.*') ? 'active' : ''); ?>">
                            <a href="#" class='sidebar-link'>
                                <i class="bi bi-cart-plus"></i>
                                <span>Compras y pedidos</span>
                            </a>
                            <ul class="submenu submenu-closed" style="--submenu-height: 215px;">
                               <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('pedidos-articulos.ver')): ?>
                                   <li class="submenu-item <?php echo e(request()->routeIs('admin.pedidos-articulos.*') ? 'active' : ''); ?>">
                                        <a href="<?php echo e(route('admin.pedidos-articulos.index')); ?>" class="submenu-link">Pedido de articulos</a>
                                    </li>
                                <?php elseif (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('pedidos-articulos.crear')): ?>
                                    <li class="submenu-item <?php echo e(request()->routeIs('admin.pedidos-articulos.*') ? 'active' : ''); ?>">
                                        <a href="<?php echo e(route('admin.pedidos-articulos.create')); ?>" class="submenu-link">Crear pedido</a>
                                    </li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('solicitudes-repuestos.ver')): ?>
                                    <li class="submenu-item <?php echo e(request()->routeIs('admin.solicitudes-repuestos.*') ? 'active' : ''); ?>">
                                        <a href="<?php echo e(route('admin.solicitudes-repuestos.index')); ?>" class="submenu-link">Solicitudes de repuestos</a>
                                    </li>
                                <?php elseif (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('solicitudes-repuestos.crear')): ?>
                                    <li class="submenu-item <?php echo e(request()->routeIs('admin.solicitudes-repuestos.*') ? 'active' : ''); ?>">
                                        <a href="<?php echo e(route('admin.solicitudes-repuestos.create')); ?>" class="submenu-link">Crear solicitud repuesto</a>
                                    </li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('ordenes-compra.ver')): ?>
                                    <li class="submenu-item <?php echo e(request()->routeIs('admin.ordenes-compra.*') ? 'active' : ''); ?>">
                                       <a href="<?php echo e(route('admin.ordenes-compra.index')); ?>" class="submenu-link">Orden de compra</a>
                                    </li>
                                <?php endif; ?>
                               
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('compras.ver')): ?>
                                    <li class="submenu-item <?php echo e(request()->routeIs('admin.compras.*') ? 'active' : ''); ?>">
                                        <a href="<?php echo e(route('admin.compras.index')); ?>" class="submenu-link">Compras</a>
                                    </li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('entradas.ver')): ?>
                                    <li class="submenu-item <?php echo e(request()->routeIs('admin.entradas.pendientes') ? 'active' : ''); ?>">
                                        <a href="<?php echo e(route('admin.entradas.pendientes')); ?>" class="submenu-link">Pendientes de entrega</a>
                                    </li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('entradas.ver')): ?>
                                    <li class="submenu-item <?php echo e(request()->routeIs('admin.entradas.*') && ! request()->routeIs('admin.entradas.pendientes') ? 'active' : ''); ?>">
                                        <a href="<?php echo e(route('admin.entradas.index')); ?>" class="submenu-link">Ingresos de articulos</a>
                                    </li>
                                <?php elseif (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('entradas.crear')): ?>
                                    <li class="submenu-item <?php echo e(request()->routeIs('admin.entradas.*') ? 'active' : ''); ?>">
                                        <a href="<?php echo e(route('admin.entradas.create')); ?>" class="submenu-link">Crear ingreso</a>
                                    </li>
                                <?php endif; ?>
                            </ul>
                        </li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['articulos.ver', 'categorias.ver', 'unidad-medidas.ver', 'inventarios.ver', 'inventario-transferencias.ver', 'entregas-herramientas.ver', 'entregas-ropa-epp.ver', 'reparaciones-articulos.ver'])): ?>
                        <li class="sidebar-item has-sub <?php echo e(request()->routeIs('admin.articulos.*') || request()->routeIs('admin.inventarios.*') || request()->routeIs('admin.entregas-herramientas.*') || request()->routeIs('admin.entregas-ropa-epp.*') || request()->routeIs('admin.reparaciones-articulos.*') || request()->routeIs('admin.categorias.*') || request()->routeIs('admin.unidad-medidas.*') ? 'active' : ''); ?>">
                            ...
                            <ul class="submenu submenu-closed" style="--submenu-height: 410px;">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('articulos.ver')): ?>
                                <li class="submenu-item <?php echo e(request()->routeIs('admin.articulos.index') || request()->routeIs('admin.articulos.create') || request()->routeIs('admin.articulos.edit') || request()->routeIs('admin.articulos.show') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('admin.articulos.index')); ?>" class="submenu-link">Articulos</a>
                                </li>
                                <li class="submenu-item <?php echo e(request()->routeIs('admin.articulos.listado') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('admin.articulos.listado')); ?>" class="submenu-link">Listados</a>
                                </li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('categorias.ver')): ?>
                                <li class="submenu-item <?php echo e(request()->routeIs('admin.categorias.*') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('admin.categorias.index')); ?>" class="submenu-link">Categorías</a>
                                </li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('unidad-medidas.ver')): ?>
                                <li class="submenu-item <?php echo e(request()->routeIs('admin.unidad-medidas.*') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('admin.unidad-medidas.index')); ?>" class="submenu-link">Unid de medida</a>
                                </li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('inventarios.ver')): ?>
                                <li class="submenu-item <?php echo e(request()->routeIs('admin.inventarios.index') || request()->routeIs('admin.inventarios.bajo-stock') || request()->routeIs('admin.inventarios.sin-stock') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('admin.inventarios.index')); ?>" class="submenu-link">Inventarios</a>
                                </li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('inventario-transferencias.ver')): ?>
                                <li class="submenu-item <?php echo e(request()->routeIs('admin.inventarios.transferencias.*') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('admin.inventarios.transferencias.index')); ?>" class="submenu-link">Transferencias</a>
                                </li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('entregas-herramientas.ver')): ?>
                                <li class="submenu-item <?php echo e(request()->routeIs('admin.entregas-herramientas.*') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('admin.entregas-herramientas.index')); ?>" class="submenu-link">Entrega herramientas</a>
                                </li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('entregas-ropa-epp.ver')): ?>
                                <li class="submenu-item <?php echo e(request()->routeIs('admin.entregas-ropa-epp.*') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('admin.entregas-ropa-epp.index')); ?>" class="submenu-link">Entrega ropa y EPP</a>
                                </li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('reparaciones-articulos.ver')): ?>
                                <li class="submenu-item <?php echo e(request()->routeIs('admin.reparaciones-articulos.*') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('admin.reparaciones-articulos.index')); ?>" class="submenu-link">Reparaciones de articulos</a>
                                </li>
                                <?php elseif (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('reparaciones-articulos.crear')): ?>
                                <li class="submenu-item <?php echo e(request()->routeIs('admin.reparaciones-articulos.*') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('admin.reparaciones-articulos.create')); ?>" class="submenu-link">Registrar reparacion</a>
                                </li>
                                <?php endif; ?>
                            </ul>
                        </li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('depositos.ver')): ?>
                        <li class="sidebar-item has-sub <?php echo e(request()->routeIs('admin.depositos.*') ? 'active' : ''); ?>">
                            <a href="#" class='sidebar-link'>
                                <i class="bi bi-card-checklist"></i>
                                <span>Depositos</span>
                            </a>
                            <ul class="submenu submenu-closed" style="--submenu-height: 86px;">
                                <li class="submenu-item <?php echo e(request()->routeIs('admin.depositos.*') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('admin.depositos.index')); ?>" class="submenu-link">Depósitos</a>
                                </li>
                            </ul>
                        </li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['ajustes.ver', 'dashboards.administrar', 'bases.ver', 'servicios-asignados.ver', 'roles.ver', 'users.ver', 'empleados.ver', 'cronogramas.ver', 'provincias.ver', 'ciudades.ver'])): ?>
                        <li class="sidebar-item has-sub <?php echo e(request()->routeIs('admin.ajustes.*') || request()->routeIs('admin.dashboards.*') || request()->routeIs('admin.bases.*') || request()->routeIs('admin.servicios-asignados.*') || request()->routeIs('admin.roles.*') || request()->routeIs('admin.users.*') || request()->routeIs('admin.empleados.*') || request()->routeIs('admin.cronogramas-laborales.*') || request()->routeIs('admin.provincias.*') || request()->routeIs('admin.ciudades.*') ? 'active' : ''); ?>">
                            ...
                            <ul class="submenu submenu-closed" style="--submenu-height: 470px;">
                                <li class="submenu-item has-sub <?php echo e(request()->routeIs('admin.ajustes.*') || request()->routeIs('admin.dashboards.*') || request()->routeIs('admin.configuracion-intervalos-servicio.*') || request()->routeIs('admin.bases.*') || request()->routeIs('admin.servicios-asignados.*') || request()->routeIs('admin.roles.*') || request()->routeIs('admin.users.*') || request()->routeIs('admin.empleados.*') || request()->routeIs('admin.cronogramas-laborales.*') || request()->routeIs('admin.provincias.*') || request()->routeIs('admin.ciudades.*') ? 'active' : ''); ?>">
                                    ...
                                    <ul class="submenu submenu-level-2 ">
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('ajustes.ver')): ?>
                                        <li class="submenu-item <?php echo e(request()->routeIs('admin.ajustes.*') ? 'active' : ''); ?>">
                                            <a href="<?php echo e(route('admin.ajustes.index')); ?>" class="submenu-link">Ajustes del sistema</a>
                                        </li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('dashboards.administrar')): ?>
                                        <li class="submenu-item <?php echo e(request()->routeIs('admin.dashboards.*') ? 'active' : ''); ?>">
                                            <a href="<?php echo e(route('admin.dashboards.index')); ?>" class="submenu-link">Dashboards</a>
                                        </li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('bases.ver')): ?>
                                        <li class="submenu-item <?php echo e(request()->routeIs('admin.bases.*') ? 'active' : ''); ?>">
                                            <a href="<?php echo e(route('admin.bases.index')); ?>" class="submenu-link">Bases</a>
                                        </li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('servicios-asignados.ver')): ?>
                                        <li class="submenu-item <?php echo e(request()->routeIs('admin.servicios-asignados.*') ? 'active' : ''); ?>">
                                            <a href="<?php echo e(route('admin.servicios-asignados.index')); ?>" class="submenu-link">Servicio asignado</a>
                                        </li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('roles.ver')): ?>
                                        <li class="submenu-item <?php echo e(request()->routeIs('admin.roles.*') ? 'active' : ''); ?>">
                                            <a href="<?php echo e(route('admin.roles.index')); ?>" class="submenu-link">Roles</a>
                                        </li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('users.ver')): ?>
                                        <li class="submenu-item <?php echo e(request()->routeIs('admin.users.*') ? 'active' : ''); ?>">
                                            <a href="<?php echo e(route('admin.users.index')); ?>" class="submenu-link">Usuarios</a>
                                        </li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('empleados.ver')): ?>
                                        <li class="submenu-item <?php echo e(request()->routeIs('admin.empleados.*') ? 'active' : ''); ?>">
                                            <a href="<?php echo e(route('admin.empleados.index')); ?>" class="submenu-link">Empleados</a>
                                        </li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('cronogramas.ver')): ?>
                                        <li class="submenu-item <?php echo e(request()->routeIs('admin.cronogramas-laborales.*') ? 'active' : ''); ?>">
                                            <a href="<?php echo e(route('admin.cronogramas-laborales.index')); ?>" class="submenu-link">Cronogramas laborales</a>
                                        </li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('provincias.ver')): ?>
                                        <li class="submenu-item <?php echo e(request()->routeIs('admin.provincias.*') ? 'active' : ''); ?>">
                                            <a href="<?php echo e(route('admin.provincias.index')); ?>" class="submenu-link">Provincias</a>
                                        </li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('ciudades.ver')): ?>
                                        <li class="submenu-item <?php echo e(request()->routeIs('admin.ciudades.*') ? 'active' : ''); ?>">
                                            <a href="<?php echo e(route('admin.ciudades.index')); ?>" class="submenu-link">Ciudades</a>
                                        </li>
                                        <?php endif; ?>
                                    </ul>
                                </li>
            ...
            <div class="siga-main-toolbar">
                ...
                <nav class="siga-toolbar-breadcrumb" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <?php if($currentBreadcrumb && ! request()->routeIs('admin.index') && ! request()->routeIs('home')): ?>
                            <?php if(! empty($currentBreadcrumb['item']) && $currentBreadcrumb['item'] !== $currentBreadcrumb['group']): ?>
                                <li class="breadcrumb-item">
                                    <a href="<?php echo e(route($currentBreadcrumb['groupRoute'])); ?>"><?php echo e($currentBreadcrumb['group']); ?></a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page"><?php echo e($currentBreadcrumb['item']); ?></li>
                            <?php else: ?>
                                <li class="breadcrumb-item active" aria-current="page"><?php echo e($currentBreadcrumb['group']); ?></li>
                            <?php endif; ?>
                        <?php endif; ?>
                    </ol>
                </nav>
                <div class="siga-toolbar-actions">
                    <form method="GET" action="<?php echo e(route('admin.global-search.index')); ?>" class="siga-global-search" role="search">
                        <div class="input-group input-group-sm">
                            <span class="input-group-text"><i class="bi bi-search"></i></span>
                            <input type="search" name="q" id="sigaGlobalSearchInput" class="form-control"
                                value="<?php echo e(request()->routeIs('admin.global-search.*') ? request('q') : ''); ?>"
                    ...
                    <?php
                        $operationalNotificationCount = \App\Models\NotificacionOperativa::query()
                            ...
                            ->count();
                    ?>
                    <a href="<?php echo e(route('admin.notificaciones-operativas.index')); ?>" class="siga-notification-toolbar-link" title="Notificaciones operativas" aria-label="Notificaciones operativas">
                        <i class="bi bi-bell"></i>
                        <span class="badge bg-light-danger <?php echo e($operationalNotificationCount > 0 ? '' : 'd-none'); ?>">
                            <?php echo e($operationalNotificationCount); ?>

                        </span>
                    </a>

                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('chat.ver')): ?>
                        <a href="<?php echo e(route('admin.chat.index')); ?>" class="siga-chat-toolbar-link" title="Chat interno" aria-label="Chat interno">
                            <i class="bi bi-chat-dots"></i>
                            <span id="chatUnreadBadge" class="badge bg-light-danger <?php echo e($chatUnreadCount > 0 ? '' : 'd-none'); ?>">
                                <?php echo e($chatUnreadCount); ?>
                    ...
                    <div class="dropdown siga-user-menu">
                        ...
                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="sigaUserMenuButton">
                            ...
                            <a href="<?php echo e(route('password.change')); ?>" class="dropdown-item">
                                <i class="bi bi-key"></i>
        ...
        <script type="application/json" id="siga-flash-data"><?php echo json_encode($flashData, 15, 512) ?></script>
        <script type="application/json" id="siga-errors-data"><?php echo json_encode($errors_messages, 15, 512) ?></script>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                function refreshChatUnread() {
                    ...
                    fetch("<?php echo e(route('admin.chat.unread')); ?>", {
                        headers: {
                            'Accept': 'application/json'
                        }
                    })
        ...
        <script type="application/json" id="siga-print-company-data"><?php echo json_encode($sigaPrintEmpresa, 15, 512) ?></script>
        <script>
        ...
        <script type="application/json" id="siga-denied-actions-data"><?php echo json_encode($deniedRouteActions ?? [], 15, 512) ?></script>
        <script type="application/json" id="siga-user-permissions-data"><?php echo json_encode(auth()->user()?->getAllPermissions()->pluck('name')->values() ?? [], 15, 512) ?></script>
        <script>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const suggestUrl = <?php echo json_encode(route('admin.global-search.suggest'), 15, 512) ?>;
                let timeoutId = null;
                let controller = null;
...
<?php /**PATH C:\wamp64\www\siga\resources\views/layouts/admin.blade.php ENDPATH**/ ?>