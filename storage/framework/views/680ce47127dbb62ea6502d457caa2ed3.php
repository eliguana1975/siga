...
<?php $__env->startSection('content'); ?>
    <div class="page-heading">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <?php if($canCreateFlota): ?>
                <a href="<?php echo e(route('admin.flota.create')); ?>" class="btn btn-primary">
    ...
    <div class="page-content">
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="GET" action="<?php echo e(route('admin.flota.index')); ?>" class="mb-3">
                        <div class="row g-2 align-items-end">
                            ...
                            <div class="col-12 col-md-4 d-flex gap-2">
                                ...
                                <a href="<?php echo e(route('admin.flota.index')); ?>" class="btn btn-light-secondary w-100 w-md-auto">Limpiar</a>
                            </div>
                        </div>
                    </form>
                    ...
                    <?php if(!empty($search ?? request('search'))): ?>
                        <div class="alert alert-success py-2 mb-3" role="alert">
                            Se encontraron <?php echo e($flotas->total()); ?> resultado(s) para "<?php echo e($search ?? request('search')); ?>".
                        </div>
                    <?php endif; ?>
                        ...
                        <table id="datatable" class="table table-striped mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th>Estado</th>
                                    <th>Seguro</th>
                                    <?php if($showFlotaActions): ?>
                                        <th class="text-end" style="width: 260px;">Acciones</th>
                                    <?php endif; ?>
                                </tr>
                            </thead>
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $flotas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $flota): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td><?php echo e($flotas->firstItem() + $loop->index); ?></td>
                                        <td><?php echo e($flota->nro_interno); ?></td>
                                        <td><?php echo e($flota->dominio); ?></td>
                                        <td><?php echo e($flota->tipoMotor?->nombre); ?></td>
                                        <td><?php echo e($flota->marcaCarroceria?->nombre); ?></td>
                                        <td><?php echo e($flota->titular?->nombre); ?></td>
                                        <td><?php echo e($flota->servicioAsignadoActual?->nombre ?? '-'); ?></td>
                                        <td>
                                            <span class="badge <?php echo e($estadoBadges[$flota->estado] ?? 'bg-light-secondary'); ?>">
                                                <?php echo e($estadoLabels[$flota->estado] ?? ucfirst((string) $flota->estado)); ?>

                                            </span>
                                        </td>
                                        <td>
                                            <span class="badge <?php echo e($seguroBadges[$flota->estado_seguro] ?? 'bg-light-secondary'); ?>">
                                                <?php echo e($flota->estado_seguro); ?>
                                        ...
                                        <td class="text-end">
                                            <div class="d-flex justify-content-end flex-wrap gap-1">
                                                ...
                                                <?php $__currentLoopData = [
                                                ...
                                                ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fotoNumero => $fotoPath): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if($fotoPath): ?>
                                                        <a href="<?php echo e(asset('storage/' . $fotoPath)); ?>"
                                                            class="btn btn-sm btn-outline-secondary"
                                                            download
                                                            title="Descargar foto <?php echo e($fotoNumero); ?>"
                                                            aria-label="Descargar foto <?php echo e($fotoNumero); ?>">
                                                    ...
                                                    <?php else: ?>
                                                        <button type="button"
                                                            class="btn btn-sm btn-outline-secondary"
                                                            disabled
                                                            title="Foto <?php echo e($fotoNumero); ?> no cargada"
                                                            aria-label="Foto <?php echo e($fotoNumero); ?> no cargada">
                                                            <i class="bi bi-download"></i>
                                                        </button>
                                                    <?php endif; ?>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                                                <a href="<?php echo e(route('admin.flota.edit', $flota->id)); ?>" class="btn btn-sm btn-success" title="Editar">
                                                    <i class="bi bi-pencil-square"></i>
                                                </a>
                                                <?php endif; ?>

                                                <?php if($canAssignFlotaService): ?>
                                                <a href="<?php echo e(route('admin.flota.servicio-asignado.edit', $flota->id)); ?>" class="btn btn-sm btn-primary" title="Asignar servicio">
                                                    <i class="bi bi-diagram-3"></i>
                                                </a>
                                                <?php endif; ?>

                                                <?php if($canViewFlotaRepuestos): ?>
                                                    <a href="<?php echo e(route('admin.flota.repuestos.index', $flota->id)); ?>" class="btn btn-sm btn-info" title="Repuestos">
                                                        <i class="bi bi-tools"></i>
                                                    </a>
                                                <?php endif; ?>

                                                <?php if($canDeleteFlota): ?>
                                                <form action="<?php echo e(route('admin.flota.destroy', $flota->id)); ?>" method="POST" class="d-inline"
                                                    onsubmit="return confirmFormSubmit(this, 'Esta seguro de eliminar el vehiculo <?php echo e(addslashes($flota->nro_interno)); ?>?');">
                                                    <?php echo csrf_field(); ?>
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <tr>
                                        <td colspan="<?php echo e($showFlotaActions ? 10 : 9); ?>" class="text-center text-muted py-4">
                    ...
                    <?php if($flotas->count() > 0): ?>
                        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-2 mt-3">
                            <small class="text-muted">
                                Mostrando <?php echo e($flotas->firstItem()); ?> a <?php echo e($flotas->lastItem()); ?> de <?php echo e($flotas->total()); ?> registros
                            </small>
                            <div>
                                <?php echo e($flotas->links('vendor.pagination.bootstrap-5-no-summary')); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\siga\resources\views/admin/flota/index.blade.php ENDPATH**/ ?>