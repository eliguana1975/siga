                    ...
                    <form method="POST" action="{{ route('admin.articulos.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="nombre" id="nombre" class="form-control"
                                        value="{{ old('nombre') }}" placeholder="Nombre del artículo" required>
                                </div>
                                @error('nombre')
                            ...
                            <div class="col-12 col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="codigo_producto" id="codigo_producto" class="form-control"
                                        value="{{ old('codigo_producto') }}" placeholder="Se genera automatico si queda vacio">
                                </div>
                            ...
                            <div class="col-6 col-md-2 mb-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="stock_maximo" id="stock_maximo" class="form-control"
                                        value="{{ old('stock_maximo', 0) }}" min="0">
                                </div>
                                @error('stock_maximo')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            ...
                            <div class="col-6 col-md-2 mb-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="stock_pedido" id="stock_pedido" class="form-control"
                                        value="{{ old('stock_pedido', 0) }}" min="0">
                                </div>
                                @error('stock_pedido')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            ...
                            <div class="col-6 col-md-2 mb-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="reposicion_modo" id="reposicion_modo" class="form-select">
                                        <option value="manual" @selected(old('reposicion_modo', 'manual') === 'manual')>No</option>
                                        <option value="automatico" @selected(old('reposicion_modo') === 'automatico')>Si</option>
                                    </select>
                                </div>
                                ...
                                <div class="border rounded px-2 py-1 article-compact-switch">
                                    ...
                                    <div class="form-check form-switch mb-0">
                                        <input class="form-check-input" type="checkbox" role="switch" id="es_herramienta"
                                            name="es_herramienta" value="1" @checked(old('es_herramienta'))>
                                ...
                                <div class="border rounded px-2 py-1 article-compact-switch">
                                    ...
                                    <div class="form-check form-switch mb-0">
                                        <input class="form-check-input" type="checkbox" role="switch" id="es_ropa_epp"
                                            name="es_ropa_epp" value="1" @checked(old('es_ropa_epp'))>
                            ...
                            <div class="col-6 col-md-2 mb-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="pasillo" id="pasillo" class="form-control"
                                        value="{{ old('pasillo') }}" maxlength="50" placeholder="Pasillo">
                                </div>
                                @error('pasillo')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            ...
                            <div class="col-6 col-md-2 mb-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="estanteria" id="estanteria" class="form-control"
                                        value="{{ old('estanteria') }}" maxlength="50" placeholder="Estanteria">
                                </div>
                                @error('estanteria')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            ...
                            <div class="col-6 col-md-2 mb-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="casillero" id="casillero" class="form-control"
                                        value="{{ old('casillero') }}" maxlength="50" placeholder="Casillero">
                                </div>
                                @error('casillero')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            ...
                            <div class="col-6 col-md-2 mb-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="estado_item" id="estado_item" class="form-select" required>
                                        <option value="activo" @selected(old('estado_item', 'activo') === 'activo')>Activo</option>
                                        <option value="inactivo" @selected(old('estado_item') === 'inactivo')>Inactivo</option>
                                    </select>
                                </div>
                                @error('estado_item')
                                    <small class="text-danger">{{ $message }}</small>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea name="observaciones" id="observaciones" class="form-control" rows="4" placeholder="Agregue cualquier observación sobre el artículo">{{ old('observaciones') }}</textarea>
                                @error('observaciones')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-4 mb-3">
                                            <div class="text-center mb-2">
                                                <img id="fotoArticuloPreview1" src="{{ old('foto_articulo_1') ? asset('storage/' . old('foto_articulo_1')) : asset('assets/static/images/samples/1.png') }}" class="img-fluid rounded" style="max-height: 180px; width: 100%; object-fit: cover;">
                                            </div>
                                        ...
                                        <div class="col-12 col-md-4 mb-3">
                                            <div class="text-center mb-2">
                                                <img id="fotoArticuloPreview2" src="{{ old('foto_articulo_2') ? asset('storage/' . old('foto_articulo_2')) : asset('assets/static/images/samples/1.png') }}" class="img-fluid rounded" style="max-height: 180px; width: 100%; object-fit: cover;">
                                            </div>
                                        ...
                                        <div class="col-12 col-md-4 mb-3">
                                            <div class="text-center mb-2">
                                                <img id="fotoArticuloPreview3" src="{{ old('foto_articulo_3') ? asset('storage/' . old('foto_articulo_3')) : asset('assets/static/images/samples/1.png') }}" class="img-fluid rounded" style="max-height: 180px; width: 100%; object-fit: cover;">
                                            </div>
