...
@section('content')
    <div class="page-heading">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h3>Entrega de ropa y EPP</h3>
                <p class="text-subtitle text-muted">Controla la ropa y los EPP asignados a empleados y sus devoluciones.</p>
            </div>
            @can('entregas-ropa-epp.crear')
                <a href="{{ route('admin.entregas-ropa-epp.create') }}" class="btn btn-primary">
    ...
    <div class="page-content">
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="GET" action="{{ route('admin.entregas-ropa-epp.index') }}" class="mb-3">
                            ...
                            <div class="col-12 col-md-8">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="search" id="search" class="form-control"
                                        ...
                                        placeholder="Empleado, prenda/EPP, deposito o estado">
                                </div>
                            </div>
                            <div class="col-12 col-md-4 d-flex gap-2">
                                <button type="submit" class="btn btn-primary w-100">Buscar</button>
                                <a href="{{ route('admin.entregas-ropa-epp.index') }}" class="btn btn-light-secondary w-100">Limpiar</a>
                            </div>
                        </div>
                    </form>
                            ...
                            <tbody>
                                @forelse ($entregas as $entrega)
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <a href="{{ route('admin.entregas-ropa-epp.show', $entrega->id) }}" class="btn btn-sm btn-info" title="Ver">
                                                <i class="bi bi-eye"></i>
                                            </a>
                                            @can('entregas-ropa-epp.editar')
                                                <a href="{{ route('admin.entregas-ropa-epp.edit', $entrega->id) }}" class="btn btn-sm btn-success" title="Editar">
                                                    <i class="bi bi-pencil-square"></i>
                                                </a>
                                            @endcan
                                            <button type="button" class="btn btn-sm btn-secondary" title="Planilla"
                                                onclick="printEntregaRopaEpp('printEntregaRopaEpp-{{ $entrega->id }}')">
    ...
    @foreach ($entregas as $entrega)
        @include('admin.entregas-ropa-epp.partials.print-planilla', ['entrega' => $entrega])
    @endforeach
@endsection

@include('admin.entregas-ropa-epp.partials.print-script')
