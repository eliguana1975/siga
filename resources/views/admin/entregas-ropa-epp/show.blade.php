...
@section('content')
    <div class="page-heading">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h3>Entrega de ropa y EPP #{{ $entrega->id }}</h3>
                <p class="text-subtitle text-muted">Detalle de ropa y EPP asignados al empleado.</p>
            </div>
            <div class="d-flex gap-2">
                <button type="button" class="btn btn-secondary" onclick="printEntregaRopaEpp('printEntregaRopaEpp-{{ $entrega->id }}')">
        ...
        <section class="section">
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Ropa / EPP entregados</h4>
                </div>
                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            @if ($detalle->cantidadPendiente() > 0)
                                                <form method="POST" action="{{ route('admin.entregas-ropa-epp.devolver', [$entrega->id, $detalle->id]) }}" class="row g-2 justify-content-end">
                                                    @csrf
            ...
            @include('admin.partials.documentos-operativos', [
                ...
                'documentableType' => 'entrega_ropa_epp',
                'documentableId' => $entrega->id,
                'editPermission' => 'entregas-ropa-epp.editar',
            ])
        </section>
    </div>
